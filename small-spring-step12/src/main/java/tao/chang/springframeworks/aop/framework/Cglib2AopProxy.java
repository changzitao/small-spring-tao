...
public class Cglib2AopProxy implements AopProxy {
    ...
    public Object getProxy() {
        ...
        enhancer.setSuperclass(advised.getTargetSource().getTargetClass().getClass());
        enhancer.setInterfaces(advised.getTargetSource().getTargetClass());
        enhancer.setCallback(new DynamicAdvisedInterceptor(advised));
        return enhancer.create();
    }

    private final class DynamicAdvisedInterceptor implements MethodInterceptor {
    ...
    private final class CglibMethodInvocation extends ReflectiveMethodInvocation {
